...
int main()
{
    //Take UserInputFor Specific Matrix Operation
    int userInput;
  cout<<"Enter 1 for addition  2 for substraction 3 for Multiplication and 4 for Exit";

    cin>>userInput;
    //If Condition for various Matrix Operation
